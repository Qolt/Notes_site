...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'azatroot',                  # Not used with sqlite3.
...
SECRET_KEY = '0-s8gw)v5y8r*d=#(&amp;t18wk)7a@q3^l!r6+=6vxw#8k855j+gq'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'notes.noreplay@gmail.com'
EMAIL_HOST_PASSWORD = 'n0tesqolt'
